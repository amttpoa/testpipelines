<x-dashboard.layout>
    ...
    <div class="max-w-xl">
        ...
        <div class="" x-data="payHandler()">
            <form method="POST" action="{{ route('dashboard.staff.conferences.hotelRequestPost',  $conference) }}">
                @csrf
                ...
                <div class="mt-4" x-data="{ count: 0 }" x-init="count = $refs.countme.value.length">
                    ...
                    <x-textarea id="comments" name="comments" rows="3" maxlength="250" x-ref="countme" x-on:keyup="count = $refs.countme.value.length" placeholder="Special requests"></x-textarea>
                </div>
